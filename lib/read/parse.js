...
Parser.prototype._tryReadEnd = function (cb) {
    console.error('>>>>> TRYING TO READ THE END')
...
Parser.prototype._consume = function (count) {
    console.error('>>>>> CONSUME %s TOKENS', count)
