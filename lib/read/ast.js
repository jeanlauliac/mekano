...
function Alias(name, desc, location) {
    if (typeof name !== 'string') throw errors.invalidArg('name', name)
...
Ref.prototype.isA = function(type) {
    if (typeof type !== 'number') throw errors.invalidArg('type', type)
    return this.type === type
}

Ref.fromString = function (str, location) {
    if (typeof str !== 'string') throw errors.invalidArg('str', str)
    var type = Ref.ALIAS
    ...
    return new Ref(type, str, location)
}
